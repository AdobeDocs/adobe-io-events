...
| `Authorization` | path | string | A JWT token; see [Authentication: Creating a JWT Token](/apis/cloudplatform/console/authentication/createjwt.html) for how to create a JWT token.  |
