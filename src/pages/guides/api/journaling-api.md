...
* An OAuth Server-to-Server token. See [Authentication: Creating an OAuth Server-to-Server Token](https://developer.adobe.com/developer-console/docs/guides/authentication/ServerToServerAuthentication/) for how to create an OAuth Server-to-Server token.
