...
<Details slots="heading,list" repeat="2" summary="(show/hide child properties)" subText="event:sequence number" />
...
<Details slots="heading" repeat="7" summary="(show/hide child properties)" subText="event:action string" />
...
<Details slots="heading" repeat="3" summary="(show/hide child properties)" subText="repo:path _string_" />
