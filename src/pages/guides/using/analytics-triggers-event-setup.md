...
When you are ready to [add events to your project](/console/docs/guides/services/services-add-event/) follow the steps provided, making sure to select **Analytics Triggers**.
